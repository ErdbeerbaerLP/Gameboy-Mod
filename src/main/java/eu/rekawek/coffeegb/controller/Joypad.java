...
public class Joypad implements AddressSpace {
    ...
    private InterruptManager imgr;
    private int p1;
    public Joypad(InterruptManager interruptManager){
        imgr = interruptManager;
    }
    public void buttonPress(ButtonListener.Button b){
        imgr.requestInterrupt(InterruptManager.InterruptType.P10_13);
        buttons.add(b);
    }
    public void buttonRelease(ButtonListener.Button b){
        buttons.remove(b);
    }
